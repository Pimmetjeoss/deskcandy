        ...
        <Link href="/" className="transition-opacity duration-500 hover:opacity-80">
          <img
            ...
            className={`h-10 w-auto transition-all duration-500 ${
              scrolled ? "md:h-10" : "md:h-16 brightness-0 invert"
            }`}
          />
        </Link>
        ...
        <div className="flex flex-col px-6 py-10 gap-6">
          {navLinks.map((link, i) => (
            <Link
              ...
              className="text-2xl font-serif font-light tracking-tight text-foreground hover:text-primary transition-colors duration-300"
